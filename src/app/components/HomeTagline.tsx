...
const HomeTagline = () => {
  return (
    <div className='flex flex-wrap px-[7%] py-[7%] items-center justify-center gap-10'>
        ...
        <div className='flex flex-wrap px-[15%] gap-4 justify-center text-center'>
        ...
        <div className='flex md:flex-row flex-col gap-10'>
            ...
            <div className='flex flex-col items-center gap-4 h-[200px] w-[300px]'>
                ...
                <Image src="/smile.svg" alt='smile' width={400} height={400} loading='lazy' quality={10} className='h-[60px]' />
            ...
            <div className='flex flex-col items-center gap-4 h-[200px] w-[300px]'>
                ...
                <Image src="/laptop.svg" alt='smile' width={400} height={400} loading='lazy' quality={10} className='h-[60px]' />
            ...
            <div className='flex flex-col items-center gap-4 h-[200px] w-[300px]'>
                ...
                <Image src="/plant.svg" alt='smile' width={400} height={400} loading='lazy' quality={10} className='h-[60px]' />
